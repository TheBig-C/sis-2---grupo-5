...
function controladorInsertarInventario($cinv, $cantidad, $estado, $sucursal_csucursal, $Producto_cp) {
    try {
        Inventario::insertarInventario($cinv, $cantidad, $estado, $sucursal_csucursal, $Producto_cp);
