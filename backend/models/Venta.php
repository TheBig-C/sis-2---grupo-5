...
class Venta {
    ...
    public static function insertarVenta($cv, $fecha, $hora, $estado, $total, $totalEntregado, $tipodepago, $ci_cliente, $Funcionario_cf) {
        ...
        $query = "INSERT INTO Venta (cv, fecha, hora, estado, total, totalEntregado, tipodepago, cliente_ci, funcionario_cf) VALUES ('$cv', '$fecha', '$hora', '$estado', $total, $totalEntregado, '$tipodepago', '$ci_cliente', '$Funcionario_cf')";
    ...
    public static function actualizarVenta($cv, $fecha, $hora, $estado, $total, $totalEntregado, $tipodepago, $ci_cliente, $Funcionario_cf) {
        ...
        $query = "UPDATE Venta SET fecha = '$fecha', hora = '$hora', estado = '$estado', total = $total, totalEntregado = $totalEntregado, tipodepago = '$tipodepago', cliente_ci = '$ci_cliente', Funcionario_cf = '$Funcionario_cf' WHERE cv = '$cv'";
        $result = pg_query($conn, $query);
        if (!$result) {
